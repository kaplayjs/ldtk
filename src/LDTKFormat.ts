// To parse this data:
//
//   import { Convert, LDTKJSONRoot } from "./file";
//
//   const lDTKJSONRoot = Convert.toLDTKJSONRoot(json);
//
...
export class Convert {
  public static toLDTKJSONRoot(json: string): LDTKJSONRoot {
    return cast(JSON.parse(json), r("LDTKJSONRoot"));
  }

  public static lDTKJSONRootToJson(value: LDTKJSONRoot): string {
    return JSON.stringify(uncast(value, r("LDTKJSONRoot")), null, 2);
  }
}
